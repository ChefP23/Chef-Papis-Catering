    ...
    <main style={{ background: '#FAF7F2', fontFamily: 'var(--font-dm-sans)' }}>
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }}>
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              {[{ icon: '🌿', title: 'Fresh Ingredients Always', desc: 'No shortcuts. Every meal starts with quality ingredients, prepared fresh.' }, { icon: '🔥', title: 'Bold, Honest Flavor', desc: 'Inspired by Caribbean roots, Maryland culture, and years of perfecting every recipe.' }, { icon: '🤝', title: 'Community First', desc: "Built for the teachers, staff, and families who keep Maryland's communities running." }].map(({ icon, title, desc }) => (
          ...
          <div style={{ position: 'relative', height: 520 }}>
            ...
            <div style={{ position: 'absolute', bottom: 60, right: -16, background: '#C49A2B', color: '#1C1C1C', padding: '16px 20px', borderRadius: 12, textAlign: 'center', fontWeight: 700, fontSize: 13, lineHeight: 1.3, boxShadow: '0 8px 32px rgba(0,0,0,0.3)' }}>
              Chef Marcus<br /><span style={{ fontSize: 11, fontWeight: 400, opacity: 0.75 }}>Founder &amp; Head Chef</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="menu" style={{ background: '#FAF7F2', padding: '80px clamp(16px, 5vw, 64px)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 20 }}>
            {[{ image: '/images/jerk-chicken.jpg', name: 'Jerk Chicken Plate', tag: 'Montgomery County Public Schools', desc: 'Slow-marinated jerk chicken, seasoned rice & beans, buttered cabbage, and candied yams.', price: 25 }, { image: '/images/alfredo.jpg', name: 'Chicken or Shrimp Alfredo', tag: 'Frederick County Public Schools', desc: 'Creamy homemade alfredo sauce over fettuccine. Choose chicken, shrimp, or both.', price: 25 }].map((item) => (
      ...
      <section id="services" style={{ background: '#F5F0E8', padding: '100px clamp(16px, 5vw, 64px)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 60 }}>
            ...
            <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: 'clamp(32px, 5vw, 56px)', color: '#2D4A3E', lineHeight: 1.1, marginBottom: 16 }}>More Ways to<br />Eat Good</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
            {[{ image: '/images/jerk-chicken.jpg', tag: 'Weekly · Fridays', title: 'Foodie Friday', desc: 'Weekly lunch delivery to MCPS, FCPS, and Frederick County school staff. Order by Wednesday, delivered Friday 10AM–1PM.', link: '/foodie-friday', cta: 'Order This Week →' }, { image: '/images/hero-bg.jpg', tag: 'Events · Corporate · Private', title: 'Event Catering', desc: 'School events, corporate lunches, and private celebrations across Montgomery, Frederick, and surrounding counties. Minimum $400.', link: '#catering', cta: 'Request a Quote →' }, { image: '/images/meal-prep.jpg', tag: 'Weekly · Sunday Pickup', title: 'Weekly Meal Prep', desc: '5 fresh meals every week. $100/week or save 25% with a 4-week commitment. Sunday pickup at 6PM.', link: '#mealprep', cta: 'Get Started →' }].map((s) => (
              <Link key={s.title} href={s.link} style={{ background: '#fff', borderRadius: 20, overflow: 'hidden', textDecoration: 'none', display: 'block', border: '1px solid rgba(0,0,0,0.06)' }}>
      ...
      <section id="gallery" style={{ background: '#FAF7F2', padding: '80px clamp(16px, 5vw, 64px)' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
            {[{ src: '/images/gallery-1.jpg', span: 2, height: 320 }, { src: '/images/gallery-2.jpg', span: 1, height: 320 }, { src: '/images/gallery-3.jpg', span: 1, height: 320 }, { src: '/images/gallery-4.jpg', span: 1, height: 260 }, { src: '/images/gallery-5.jpg', span: 1, height: 260 }, { src: '/images/gallery-6.jpg', span: 2, height: 260 }].map((img, i) => (
      ...
      <section id="mealprep" style={{ background: '#2D4A3E', padding: '100px clamp(16px, 5vw, 64px)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', textAlign: 'center' }}>
          <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: 2.5, textTransform: 'uppercase', color: '#E8B84B', marginBottom: 12 }}>Meal Prep</div>
          <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: 'clamp(32px, 4vw, 52px)', color: '#fff', marginBottom: 16 }}>I Cook. You Eat.</h2>
          <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.6)', maxWidth: 560, lineHeight: 1.7, margin: '0 auto 52px' }}>5 fresh meals every week. Pick up Sunday at 6PM.</p>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24, maxWidth: 560, margin: '0 auto' }}>
            <div style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 20, padding: 32 }}>
              <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', marginBottom: 12, textTransform: 'uppercase', letterSpacing: 1 }}>Weekly</div>
              ...
              <Link href="/login" style={{ display: 'block', padding: 14, background: '#C49A2B', color: '#1C1C1C', borderRadius: 10, fontWeight: 700, textAlign: 'center', textDecoration: 'none', fontSize: 14 }}>Start Weekly</Link>
            </div>
            <div style={{ background: 'linear-gradient(135deg, #9B1515, #C41E1E)', borderRadius: 20, padding: 32, position: 'relative' }}>
              ...
              <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)', marginBottom: 12, textTransform: 'uppercase', letterSpacing: 1 }}>4 Weeks</div>
              ...
              <Link href="/login" style={{ display: 'block', padding: 14, background: '#C49A2B', color: '#1C1C1C', borderRadius: 10, fontWeight: 700, textAlign: 'center', textDecoration: 'none', fontSize: 14 }}>Get 4 Weeks</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="reviews" style={{ background: '#FAF7F2', padding: '100px clamp(16px, 5vw, 64px)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2 style={{ fontFamily: 'var(--font-playfair)', fontSize: 'clamp(32px, 4vw, 52px)', color: '#2D4A3E' }}>The Community<br />Speaks</h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 20 }}>
            {reviews.map((r) => (
              <div key={r.name} style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.06)', borderRadius: 16, padding: 28, textAlign: 'center' }}>
      ...
      <section style={{ background: '#1C1C1C', textAlign: 'center', padding: '100px clamp(16px, 5vw, 64px)' }}>
