  ...
  return (
    <div className="grid grid-cols-4 gap-2 mb-6">
      {[
        ...
        <div key={label} className="rounded-xl p-3 text-center" style={{ background: 'rgba(196,30,30,0.35)', border: '2px solid rgba(255,255,255,0.25)' }}>
          <div style={{ fontFamily: 'monospace', fontSize: 42, fontWeight: 900, color: '#FFFFFF', textShadow: '0 0 20px rgba(255,255,255,0.5)', lineHeight: 1 }}>
...
export default function Home() {
  ...
  const menuItems = [
    { emoji: '🍗', name: 'Jerk Chicken Plate', desc: 'Slow-marinated jerk chicken, seasoned rice & beans, buttered cabbage, and candied yams.', price: 25 },
  ]
    ...
    <main style={{ background: 'var(--warm-white)' }}>
      ...
      <section style={{ background: 'linear-gradient(135deg, var(--charcoal) 0%, var(--black) 50%, #1a0500 100%)', padding: 'clamp(60px, 10vw, 100px) clamp(16px, 5vw, 48px)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 60, alignItems: 'center' }}>
          ...
          <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(212,160,23,0.25)', borderRadius: 20, padding: 32, backdropFilter: 'blur(10px)' }}>
            ...
            <Countdown cutoff={cycle?.cutoff_datetime || ''} />
      ...
      <section id="menu" style={{ background: 'var(--cream)', padding: '80px clamp(16px, 5vw, 48px)' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <h2 style={{ fontSize: 'clamp(28px, 4vw, 48px)', marginBottom: 8 }}>Foodie Friday – {deliveryDate}</h2>
          <p style={{ fontSize: 14, color: 'var(--text-light)', marginBottom: 40 }}>Delivery: Friday 10AM–1PM EST · Main Office Drop-off Only · MCPS & FCPS</p>
